...
mod tests {
    ...
    #[test]
    fn parses_responses_cached_input_usage() {
        let usage = model_usage_from_openai_value(&serde_json::json!({
            "usage": {
                "input_tokens": 3745,
                "output_tokens": 42,
                "total_tokens": 3787,
        ...
        assert_eq!(usage.input_tokens, Some(3745));
        assert_eq!(usage.cached_input_tokens, Some(3328));

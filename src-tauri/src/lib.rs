...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let beefapi_account = std::sync::Arc::new(
                beefapi::account::AccountService::production(
                    app.path()
                        .app_data_dir()
                        .map_err(|error| std::io::Error::other(error.to_string()))?
                        .join("beefapi-account.json"),
                )
...

            {
                ...
                tauri::async_runtime::spawn(async move {
                    ...
                    state
                        .beefapi_account
                        .reconcile(move |account| {
                            beefapi::account::emit_account_state(&event_app, &account)
                        })
                        .await;
                });
            }
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            beefapi::account::beefapi_auth_cancel,
            beefapi::account::beefapi_auth_reopen_browser,
            beefapi::account::beefapi_logout,
            ...
            client_plugins::managed::managed_clients_inspect,
            client_plugins::managed::managed_clients_apply,
            client_plugins::managed::managed_clients_verify,
            client_plugins::managed::managed_clients_rollback,
            ...
            external_agents::commands::chat_pi_rpc_command,

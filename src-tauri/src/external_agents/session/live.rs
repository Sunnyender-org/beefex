...
use crate::external_agents::session::pi_rpc::{PiExtensionUiExchange, PiRpcCommand};
...
pub enum SessionCommand {
    ...
    RunTurn {
        ...
        pi_extension_ui: Option<mpsc::Sender<PiExtensionUiExchange>>,
        done: oneshot::Sender<Result<(), String>>,
    },
    /// Execute one typed Pi RPC command against the Task-owned live process.
    Rpc {

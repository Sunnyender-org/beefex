...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct ChatChangedFileReceipt {
    pub path: String,
    pub additions: usize,
    pub removals: usize,
    pub has_diff: bool,
...
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq, Eq)]
pub struct ChatCompletionReceipt {
    #[serde(default)]
    pub changed_files: Vec<ChatChangedFileReceipt>,
    #[serde(default)]
    pub commands: Vec<ChatCommandReceipt>,
    #[serde(default)]
...
pub struct Conversation {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_run_status: Option<crate::state::ChatRunStatus>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_run_id: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_run_terminal_at: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_run_receipt: Option<ChatCompletionReceipt>,
}
...
impl From<&Conversation> for ConversationListItem {
    fn from(conv: &Conversation) -> Self {
        ...
        ConversationListItem {
            ...
            last_run_status: conv.last_run_status,
            last_run_id: conv.last_run_id.clone(),
            last_run_terminal_at: conv.last_run_terminal_at,
        }
    }
}

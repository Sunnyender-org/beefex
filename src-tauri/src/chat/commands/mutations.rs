...
use super::{
    complete_assistant_reply, persist_latest_terminal_run_projection, ChatSendReservation,
...
pub(crate) fn chat_fork_conversation(
    ...
    let conversation = Conversation {
        ...
        last_run_id: source.last_run_id.clone(),
        last_run_terminal_at: source.last_run_terminal_at,
        last_run_receipt: source.last_run_receipt.clone(),
    };

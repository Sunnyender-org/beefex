...
const OUTPUTS_ROOT: &str = "Beefex/outputs";
...
const LEGACY_RUNS_ROOT: &str = "Beefex/runs";
...
/// Startup GC for the legacy ephemeral exports tree (`~/Beefex/runs/`) from
...
/// are eventually removed; nothing writes to `~/Beefex/runs/` anymore.

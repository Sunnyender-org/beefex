...
describe('MessageBubble persisted external-agent synthesis', () => {
  it('renders an identical terminal synthesis only once after hydration', () => {
    const message: ChatMessage = {
      id: 'external-hydrated',
      role: 'assistant',
      content: 'Completed exactly once',
      segments: [
        { id: 'tool', kind: 'tool', phase: 'tool_loop', order: 1, tool_call_id: 'call-1' },
        { id: 'live-final', kind: 'text', phase: 'tool_loop', order: 2, text: 'Completed exactly once' },
        { id: 'stored-final', kind: 'text', phase: 'synthesis', order: 3, text: 'Completed exactly once' },
      ],
      tool_calls: [{
        id: 'call-1',
        name: 'bash',
    ...
    expect(screen.getAllByText('Completed exactly once')).toHaveLength(1)
  })
})

      ...
      <div ref={innerRef} className={`relative ${innerClass}`}>
        {toolPanelOpen && (
          <>
            ...
            <div
              className={`chat-motion-popover absolute inset-x-0 z-40 overflow-hidden rounded-[6px] border border-[var(--theme-surface-border)] bg-[var(--theme-surface)] shadow-[0_10px_28px_rgba(0,0,0,0.14)] dark:border-neutral-700 dark:bg-neutral-900 ${projectPanelPlacementClass}`}
        ...
        {slashPanelOpen && (
          <div
            className={`chat-motion-popover absolute z-40 overflow-hidden rounded-[6px] border border-[var(--theme-surface-border)] bg-[var(--theme-surface)] p-0.5 font-sans shadow-[0_6px_18px_-16px_rgba(0,0,0,0.2),0_1px_4px_rgba(0,0,0,0.05)] dark:border-neutral-700 dark:bg-neutral-900 ${slashPanelPlacementClass}`}
            style={{
        ...
        {projectMenuOpen && projectEntryEnabled && (
          <>
            ...
            />
            <div
              className={`chat-motion-popover absolute inset-x-0 z-40 overflow-visible rounded-[6px] border border-[var(--theme-surface-border)] bg-[var(--theme-surface)] p-1 shadow-[0_10px_24px_rgba(0,0,0,0.12)] dark:border-neutral-700 dark:bg-neutral-900 ${projectPanelPlacementClass}`}
              style={{ ['--chat-popover-origin' as string]: projectPanelOrigin }}
              data-tauri-drag-region="false"
            >
              ...
              <div className="mt-0.5 border-t border-neutral-200/80 pt-0.5 dark:border-neutral-800">
                ...
                <div className="relative">
                  ...
                  {projectCreateMenuOpen && (
                    <div
                      className="absolute left-0 top-full z-50 mt-1 w-[152px] rounded-[6px] border border-[var(--theme-surface-border)] bg-[var(--theme-surface)] p-1 shadow-[0_10px_24px_rgba(0,0,0,0.12)] dark:border-neutral-700 dark:bg-neutral-900 sm:bottom-0 sm:left-full sm:top-auto sm:mt-0 sm:ml-1"
                      role="menu"
                    >
                      <button
                        type="button"
        ...
        >
          {dragActive && (
            <div className="chat-motion-fade-up mb-2 rounded-[5px] border border-dashed border-[var(--beef-active)] bg-[var(--accent-soft)] px-3 py-2 text-center text-[13px] font-medium text-[var(--beef-active)]">
              松开即可添加附件
            </div>
          )}
              ...
              <div className="relative shrink-0 self-center">
                ...
                {modeMenuOpen && (
                  <>
                    ...
                    <div
                      className={`chat-motion-popover absolute right-0 z-40 w-[min(236px,calc(100vw-32px))] overflow-visible rounded-[6px] border border-[var(--theme-surface-border)] bg-[var(--theme-surface)] p-1 shadow-[0_10px_24px_rgba(0,0,0,0.12)] dark:border-neutral-700 dark:bg-neutral-900 ${projectPanelPlacementClass}`}
            ...
            <div className="relative h-9 w-9 shrink-0">
              <button
                ...
                className={`absolute inset-0 flex items-center justify-center rounded-[2px] transition-all duration-[var(--kv-dur-fast)] ease-[var(--kv-ease-spring)] ${
                  ...
                  canSend
                    ? `bg-[var(--beef-active)] text-[#FFF8F0] shadow-sm hover:bg-[var(--beef-pressed)] active:scale-90${

      ...
      <div className="flex items-start gap-3 rounded-xl border border-indigo-100 bg-indigo-50/70 px-4 py-3 dark:border-indigo-900/50 dark:bg-indigo-950/30">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-xs leading-relaxed text-indigo-700/80 dark:text-indigo-300/80">
            {t(
              'RAG（检索增强生成）允许 AI 检索你导入的私有文档，以提供更准确的回复。Beefex 在本机解析、分块并建立向量索引，数据不出本机。',
              'RAG (retrieval-augmented generation) lets the AI search your own documents for grounded answers. Beefex parses, chunks and indexes everything locally; data never leaves your machine.',
            )}
          </p>
        </div>
      </div>
